...
public class MessageDiretto {
	...
	private static Logger log = LogManager.getLogger(MessageDiretto.class);
	...
	public MessageDiretto(byte[] range, Date date) {
		...
		lastindex = (diginput / 8) + (analog * 3) + 8 + (digoutout / 8);
	...
	public String toString() {
		return (Address != null ? "Address: " + Address + ",  " : "")
				+ (diagnostica != null ? "bitdiagnostica: " + diagnostica + ",  " : "") + "diginput: " + diginput
				+ ",  analog: " + analog + ",  digoutout: " + digoutout + ",  "
